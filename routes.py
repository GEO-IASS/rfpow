...
_routes = [
    ...
    RedirectRoute(r'/rfp/search<method:(\.comet)?>/<search_query:.*>', RFPSearch, name='secure', strict_slash=True),
    RedirectRoute(r'/rfp/list<method:(\.comet)?>', RFPList, name='secure', strict_slash=True),
