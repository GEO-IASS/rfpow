...
_routes = [
    ...
    RedirectRoute(r'/rfp/subscribe/<keyword>', SubscribeHandler, name='secure', strict_slash=True),
    RedirectRoute(r'/rfp/unsubscribe/<keyword>', UnsubscribeHandler, name='secure', strict_slash=True),
